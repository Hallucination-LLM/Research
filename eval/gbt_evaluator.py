...
def evaluate_response(document, gt_response, response, tokenizer, data_type=DataType.SUMMARIZATION, model='gpt-4o-2024-05-13'):
    ...
    return decision, text, problematic_spans, cost, prompt
    ...
    with open(output_path, 'w') as fw:
        ...
        for idx in range(len(responses)):
            ...
            if idx in done_dict:
                ...
                continue
            decision, gpt4_explanation, problematic_spans, cost, prompt = evaluate_response(
...
# OPENAI_API_KEY=[KEY] python eval/gbt_evaluator.py --hyp data/response.csv --ref data/golden_data.csv --out data/eval.jsonl --limit 2